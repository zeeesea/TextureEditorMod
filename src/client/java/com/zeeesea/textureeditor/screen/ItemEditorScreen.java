...
public class ItemEditorScreen extends Screen {
    ...
    public ItemEditorScreen(ItemStack itemStack) {
    ...
    protected void init() {
        ...
        if (tex != null) {
            ...
            System.out.println("[TextureEditor] Item texture extracted: " + textureId + " sprite: " + spriteId + " size: " + tex.width() + "x" + tex.height());
            ...
            System.out.println("[TextureEditor] FAILED to extract item texture for: " + itemName);
        }
    ...
    @Override public boolean keyPressed(int kc, int sc, int m) {
        ...
        if (kc == GLFW.GLFW_KEY_EQUAL || kc == GLFW.GLFW_KEY_KP_ADD) { if (zoom < 40) { zoom += 2; recalcCanvasPos(); } return true; }
        if (kc == GLFW.GLFW_KEY_MINUS || kc == GLFW.GLFW_KEY_KP_SUBTRACT) { if (zoom > 2) { zoom -= 2; recalcCanvasPos(); } return true; }
    ...
    private void applyLive() {
        ...
        System.out.println("[TextureEditor] Applying live item texture: " + spriteId);
