...
public class ExternalEditorSettingsScreen extends Screen {
    ...
    public ExternalEditorSettingsScreen(Screen parent) {
        super(Component.literal("External Editor Settings"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        addDrawableChild(Button.builder(
                Component.literal("Use External Editor: " + (s.useExternalEditor ? "\u00a7aON" : "\u00a7cOFF")),
                btn -> {
        ...
        y += 12;
        customPathField = new EditBox(this.textRenderer, centerX - 120, y, 240, 18, Component.literal("Custom Path"));
        ...
        customPathField.setChangedListener(text -> {
            s.externalEditorCustomPath = Component.trim();
            s.save();
        });
        ...
        addDrawableChild(Button.builder(
                Component.literal("\u00a7eRefresh Detection"),
                btn -> {
        ...
        // Delete Cache button
        addDrawableChild(Button.builder(
                Component.literal("\u00a7cDelete Cache"),
                btn -> {
        ...
        addDrawableChild(Button.builder(
                Component.literal("\u00a7cReset All Textures"),
                btn -> {
