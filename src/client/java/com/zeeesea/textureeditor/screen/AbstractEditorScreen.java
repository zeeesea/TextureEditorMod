    ...
    private int buildToolsTab(int py, int px, int w, int bh, ModSettings s) {
        ...
        switch (currentTool) {
            case SELECT -> {
                ...
                ButtonWidget replaceBtn = ButtonWidget.builder(Text.literal(selectionCombineMode == SelectionCombineMode.REPLACE ? "[Replace]" : "Replace"), btn -> {
                ...
                int addX = px + w1 + 1;
                ButtonWidget addBtn = ButtonWidget.builder(Text.literal(selectionCombineMode == SelectionCombineMode.ADD ? "[Add]" : "Add"), btn -> {
                ...
                int subX = addX + w2 + 1;
                ButtonWidget subBtn = ButtonWidget.builder(Text.literal(selectionCombineMode == SelectionCombineMode.SUBTRACT ? "[Subtract]" : "Subtract"), btn -> {
